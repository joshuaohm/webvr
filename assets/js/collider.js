...
AFRAME.registerComponent('collider', {
  ...
  tick: function (t) {
    ...
    var raycaster;
    var vertices = new THREE.Geometry().fromBufferGeometry(mesh.geometry).vertices;
    ...
    collisionResults.forEach(function (target) {
      ...
      target.object.el.emit('hit', [{target: el}, {pointValue: target.object.el.getAttribute('hit-listener').pointValue}]);
    });
  }
});  